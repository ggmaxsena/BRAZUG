...
function mapCharacterRow(row) {
  ...
  return {
    ...
    prof1_300: !!row.prof1_300,
    prof2_name: row.prof2_name || "",
    prof2_300: !!row.prof2_300,
    sec1_name: row.sec1_name || "",
    sec1_300: !!row.sec1_300,
    sec2_name: row.sec2_name || "",
    sec2_300: !!row.sec2_300,
...
async function createCharacter(data, userId = null) {
  ...
  const result = await client.query(
    `INSERT INTO wow_characters (
      ...
      prof1_name, prof1_300, prof2_name, prof2_300,
      sec1_name, sec1_300, sec2_name, sec2_300,
    ...
    [
      ...
      "us",
      "doomhowl",
      String(data.prof1_name || ""), !!data.prof1_300,
      String(data.prof2_name || ""), !!data.prof2_300,
      String(data.sec1_name || ""), !!data.sec1_300,
      String(data.sec2_name || ""), !!data.sec2_300,
...
async function updateCharacter(id, data, authenticatedUser = null) {
  ...
  const result = await client.query(
    ...
    [
      ...
      data.prof1_300 !== undefined ? !!data.prof1_300 : char.prof1_300,
      String(data.prof2_name !== undefined ? data.prof2_name : char.prof2_name),
      data.prof2_300 !== undefined ? !!data.prof2_300 : char.prof2_300,
      String(data.sec1_name !== undefined ? data.sec1_name : char.sec1_name),
      data.sec1_300 !== undefined ? !!data.sec1_300 : char.sec1_300,
      String(data.sec2_name !== undefined ? data.sec2_name : char.sec2_name),
      data.sec2_300 !== undefined ? !!data.sec2_300 : char.sec2_300,
