...
- **Grid Fallback**: Se o payload da Blizzard não fornecer `talent.row`/`talent.column`, o frontend aplica um fallback em lista para mostrar todos os talentos de forma legível.
- **Rank Display**: Cada talento exibe `rank/maxRank` e inclui um status visual consistente com o estilo Wowhead Classic.
